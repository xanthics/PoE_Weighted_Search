#!/usr/bin/python
# -*- coding: utf-8 -*-
# Generated: 06/08/2019(m/d/y) 04:05:33 utc
mods = {
	...
	"# to Melee Weapon and Unarmed Attack range": ["crafted.stat_2264295449", "explicit.stat_2264295449", "implicit.stat_2264295449"],
	...
	"#% additional Elemental Resistances during Flask effect": ["explicit.stat_962725504", "fractured.stat_962725504"],
	...
	"#% chance to Intimidate Enemies for 4 seconds on Hit": ["explicit.stat_2089652545", "explicit.stat_78985352"],
	...
	"#% increased Accuracy Rating (Local)": ["explicit.stat_3647521724", "implicit.stat_3647521724"],
	...
	"#% increased Amount Recovered": ["explicit.stat_700317374", "fractured.stat_700317374"],
	...
	"#% increased Curse Duration": ["crafted.stat_3824372849", "explicit.stat_3824372849"],
	...
	"#% increased Damage with Maces": ["explicit.stat_1181419800"],
	...
	"#% increased Recovery rate": ["explicit.stat_173226756", "fractured.stat_173226756"],
	...
	"#% of Maximum Life to Maximum total Recovery per second from Life Leech": ["explicit.stat_2291332709"],
	...
	"#% of Spell Damage Leeched as Energy Shield": ["implicit.stat_11106713"],
	...
	"Maximum Power Charges is 0": ["explicit.stat_1791497458"],
	...
	"Unique Boss deals #% increased Damage": ["explicit.stat_124877078", "implicit.stat_124877078"],
	...
	"Unique Boss has #% increased Area of Effect": ["explicit.stat_3040667106", "implicit.stat_3040667106"],
	"Unique Boss has #% increased Attack and Cast Speed": ["explicit.stat_2109106920", "implicit.stat_2109106920"],
	"Unique Boss has #% increased Life": ["explicit.stat_1959158336", "implicit.stat_1959158336"],
	...
	"Vaal Pact": ["explicit.stat_2257118425", "explicit.stat_3204150184"],
