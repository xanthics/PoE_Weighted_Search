...
mods = {
	" Animated Minions' Melee Attacks deal #% more Damage to surrounding targets": ["explicit.stat_478698670"],
	...
	"# Energy Shield Regenerated per second": ["explicit.stat_2561836520", "explicit.stat_1330109706"],
	...
	"# Life gained for each Enemy hit by your Attacks": ["explicit.stat_2797971005", "implicit.stat_2797971005", "crafted.stat_2797971005"],
	...
	"# to Accuracy Rating": ["explicit.stat_803737631", "crafted.stat_803737631"],
	"# to Accuracy Rating (Local)": ["explicit.stat_691932474", "implicit.stat_691932474", "crafted.stat_691932474"],
	...
	"# to Armour (Local)": ["explicit.stat_3484657501", "crafted.stat_3484657501"],
	...
	"# to Dexterity": ["explicit.stat_3261801346", "implicit.stat_3261801346", "crafted.stat_3261801346"],
	...
	"# to Evasion Rating (Local)": ["explicit.stat_53045048", "crafted.stat_53045048"],
	...
	"# to Intelligence": ["explicit.stat_328541901", "implicit.stat_328541901", "crafted.stat_328541901"],
	...
	"# to Strength": ["explicit.stat_4080418644", "implicit.stat_4080418644", "crafted.stat_4080418644"],
	...
	"# to Weapon range": ["explicit.stat_350598685", "implicit.stat_350598685", "crafted.stat_350598685"],
	"# to Zombie maximum Life": ["explicit.stat_4116579804"],
	"# to all Attributes": ["explicit.stat_1379411836", "implicit.stat_1379411836", "crafted.stat_1379411836"],
	"# to maximum Energy Shield": ["explicit.stat_3489782002", "implicit.stat_3489782002", "crafted.stat_3489782002"],
	"# to maximum Energy Shield (Local)": ["explicit.stat_4052037485", "crafted.stat_4052037485"],
	"# to maximum Life": ["explicit.stat_3299347043", "implicit.stat_3299347043", "crafted.stat_3299347043"],
	"# to maximum Mana": ["explicit.stat_1050105434", "implicit.stat_1050105434", "crafted.stat_1050105434"],
	"# to maximum number of Skeletons": ["explicit.stat_2428829184", "crafted.stat_2428829184"],
	...
	"# to maximum number of Zombies": ["explicit.stat_1652515349", "implicit.stat_1652515349", "crafted.stat_1652515349"],
	"#% Chance for Traps to Trigger an additional time": ["explicit.stat_1087710344"],
	"#% Chance to Block (Shields)": ["explicit.stat_4253454700", "implicit.stat_4253454700", "crafted.stat_4253454700"],
	"#% Chance to Block Attack Damage": ["explicit.stat_2530372417", "explicit.stat_1702195217", "implicit.stat_2530372417", "crafted.stat_1702195217"],
	...
	"#% Chance to Block Attack Damage per Endurance Charge": ["explicit.stat_3039589351", "explicit.stat_2355741828"],
	...
	"#% Chance to Block Attack Damage while Dual Wielding": ["explicit.stat_2166444903", "implicit.stat_2166444903", "crafted.stat_2166444903"],
	...
	"#% Chance to Block Spell Damage": ["explicit.stat_561307714", "explicit.stat_2881111359", "implicit.stat_561307714", "implicit.stat_2881111359"],
	...
	"#% additional Chance to receive a Critical Strike": ["explicit.stat_1437192935", "implicit.stat_1437192935"],
	...
	"#% chance to Avoid being Chilled": ["explicit.stat_3483999943", "crafted.stat_3483999943"],
	...
	"#% chance to Avoid being Frozen": ["explicit.stat_1514829491", "implicit.stat_1514829491", "crafted.stat_1514829491"],
	...
	"#% chance to Avoid being Ignited": ["explicit.stat_1783006896", "implicit.stat_1783006896", "crafted.stat_1783006896"],
	...
	"#% chance to Avoid being Shocked": ["explicit.stat_1871765599", "implicit.stat_1871765599", "crafted.stat_1871765599"],
	"#% chance to Avoid being Shocked while Chilled": ["explicit.stat_3981960937"],
	"#% chance to Avoid being Stunned": ["explicit.stat_4262448838", "crafted.stat_4262448838"],
	...
	"#% chance to Dodge Spell Hits": ["explicit.stat_696707743", "implicit.stat_696707743"],
	...
	"#% chance to Freeze": ["explicit.stat_2309614417", "crafted.stat_2309614417"],
	...
	"#% chance to Ignite": ["explicit.stat_1335054179", "crafted.stat_1335054179"],
	...
	"#% chance to Shock": ["explicit.stat_1538773178", "crafted.stat_1538773178"],
	...
	"#% chance to cause Bleeding on Hit": ["explicit.stat_1519615863", "implicit.stat_1519615863", "crafted.stat_1519615863"],
	...
	"#% chance to gain Onslaught for 4 seconds on Kill": ["explicit.stat_665823128", "explicit.stat_3023957681", "implicit.stat_3023957681"],
	...
	"#% faster start of Energy Shield Recharge": ["explicit.stat_1782086450", "crafted.stat_1782086450"],
	"#% faster start of Energy Shield Recharge during any Flask Effect": ["explicit.stat_1912660783"],
	...
	"#% increased Arctic Armour Mana Reservation": ["explicit.stat_2233726619"],
	"#% increased Area Damage": ["explicit.stat_4251717817"],
	"#% increased Area Damage taken from Hits": ["implicit.stat_3001376862"],
	...
	"#% increased Armour": ["explicit.stat_2866361420", "crafted.stat_2866361420"],
	"#% increased Armour (Local)": ["explicit.stat_1062208444", "crafted.stat_1062208444"],
	"#% increased Armour against Projectiles": ["explicit.stat_706246936"],
	"#% increased Armour and Energy Shield": ["explicit.stat_3321629045", "crafted.stat_3321629045"],
	"#% increased Armour and Evasion": ["explicit.stat_2451402625", "crafted.stat_2451402625"],
	...
	"#% increased Attack Speed": ["explicit.stat_681332047", "implicit.stat_681332047", "crafted.stat_681332047"],
	"#% increased Attack Speed (Local)": ["explicit.stat_210067635", "implicit.stat_210067635", "crafted.stat_210067635"],
	...
	"#% increased Attack and Cast Speed per Frenzy Charge": ["explicit.stat_269590092"],
	...
	"#% increased Cast Speed": ["explicit.stat_2891184298", "implicit.stat_2891184298", "crafted.stat_2891184298"],
	...
	"#% increased Chance to Block Attack and Spell Damage": ["explicit.stat_4147897060"],
	"#% increased Chaos Damage": ["explicit.stat_736967255", "implicit.stat_736967255"],
	"#% increased Chaos Damage for each Equipped Corrupted Item": ["implicit.stat_4004011170"],
	...
	"#% increased Chaos Damage taken": ["explicit.stat_2960683632", "implicit.stat_2960683632"],
	"#% increased Chaos Damage taken over time": ["explicit.stat_3762784591"],
	...
	"#% increased Chill Duration on Enemies": ["explicit.stat_3485067555", "crafted.stat_3485067555"],
	...
	"#% increased Cold Damage": ["explicit.stat_3291658075", "implicit.stat_3291658075", "crafted.stat_3291658075"],
	...
	"#% increased Cold Damage taken": ["explicit.stat_3303114033", "implicit.stat_3303114033"],
	...
	"#% increased Conductivity Mana Reservation": ["explicit.stat_622203853"],
	...
	"#% increased Critical Strike Chance": ["explicit.stat_2375316951", "implicit.stat_2375316951", "crafted.stat_2375316951"],
	...
	"#% increased Critical Strike Chance for Spells": ["explicit.stat_737908626", "crafted.stat_737908626"],
	...
	"#% increased Critical Strike Chance per Power Charge": ["explicit.stat_2102212273"],
	...
	"#% increased Curse Duration": ["explicit.stat_3824372849", "crafted.stat_3824372849"],
	...
	"#% increased Damage for each Equipped Magic Item": ["explicit.stat_886366428"],
	...
	"#% increased Damage over Time": ["explicit.stat_967627487", "implicit.stat_967627487", "crafted.stat_967627487"],
	...
	"#% increased Damage taken from Damage Over Time": ["crafted.stat_1101403182"],
	"#% increased Damage taken from Ghosts": ["explicit.stat_2156764291"],
	"#% increased Damage taken from Projectiles": ["implicit.stat_1425651005"],
	...
	"#% increased Despair Mana Reservation": ["explicit.stat_2562564343"],
	...
	"#% increased Effect of Chill on you": ["explicit.stat_1478653032"],
	...
	"#% increased Elemental Damage Taken while stationary": ["explicit.stat_3859593448"],
	...
	"#% increased Elemental Damage taken when Hit per Endurance Charge": ["explicit.stat_1686913105"],
	"#% increased Elemental Damage taken while stationary": ["explicit.stat_983989924"],
	"#% increased Elemental Damage with Attack Skills": ["explicit.stat_387439868", "implicit.stat_387439868", "crafted.stat_387439868"],
	...
	"#% increased Energy Shield": ["explicit.stat_4015621042", "crafted.stat_4015621042"],
	...
	"#% increased Evasion Rating": ["explicit.stat_2106365538", "crafted.stat_2106365538"],
	"#% increased Evasion Rating (Local)": ["explicit.stat_124859000", "crafted.stat_124859000"],
	...
	"#% increased Evasion and Energy Shield": ["explicit.stat_1999113824", "crafted.stat_1999113824"],
	...
	"#% increased Fire Damage": ["explicit.stat_3962278098", "implicit.stat_3962278098", "crafted.stat_3962278098"],
	...
	"#% increased Fishing Pool Consumption": ["explicit.stat_1550221644"],
	"#% increased Fishing Range": ["explicit.stat_170497091"],
	"#% increased Flammability Mana Reservation": ["explicit.stat_3152149523"],
	...
	"#% increased Flask Charges used": ["explicit.stat_644456512"],
	"#% increased Flask Life Recovery rate": ["explicit.stat_51994685", "crafted.stat_51994685"],
	"#% increased Flask Mana Recovery rate": ["explicit.stat_1412217137", "crafted.stat_1412217137"],
	"#% increased Flask effect duration": ["explicit.stat_3741323227", "crafted.stat_3741323227"],
	"#% increased Freeze Duration on Enemies": ["explicit.stat_1073942215", "crafted.stat_1073942215"],
	"#% increased Frenzy Charge Duration": ["explicit.stat_3338298622"],
	"#% increased Frenzy Charge Duration per Frenzy Charge": ["explicit.stat_2543931078"],
	"#% increased Frostbite Mana Reservation": ["explicit.stat_4272260340"],
	...
	"#% increased Global Critical Strike Chance": ["explicit.stat_587431675", "implicit.stat_587431675", "crafted.stat_587431675"],
	...
	"#% increased Golem Size": ["explicit.stat_2576412389"],
	"#% increased Herald of Ice Damage": ["explicit.stat_3910961021"],
	"#% increased Herald of Thunder Buff Effect": ["explicit.stat_3814686091"],
	"#% increased Ignite Duration on Enemies": ["explicit.stat_1086147743", "crafted.stat_1086147743"],
	...
	"#% increased Intelligence for each Equipped Unique Item": ["explicit.stat_4207939995"],
	...
	"#% increased Life Leeched per second for each Equipped Corrupted Item": ["implicit.stat_3815042054"],
	...
	"#% increased Lightning Damage": ["explicit.stat_2231156303", "implicit.stat_2231156303", "crafted.stat_2231156303"],
	...
	"#% increased Lightning Damage taken": ["explicit.stat_1276918229", "implicit.stat_1276918229"],
	...
	"#% increased Mana Cost of Minion Skills": ["explicit.stat_2969128501"],
	"#% increased Mana Cost of Raise Spectre": ["explicit.stat_262301496"],
	"#% increased Mana Cost of Skills for each 200 total Mana you have Spent Recently": ["explicit.stat_2650053239"],
	"#% increased Mana Cost of Skills when on Low Life": ["explicit.stat_73272763"],
	"#% increased Mana Cost of Totem Skills that cast an Aura": ["explicit.stat_2701327257"],
	"#% increased Mana Leeched per second": ["explicit.stat_690135178"],
	"#% increased Mana Leeched per second for each Equipped Corrupted Item": ["implicit.stat_2679819855"],
	...
	"#% increased Mana Regeneration Rate": ["explicit.stat_789117908", "implicit.stat_789117908", "crafted.stat_789117908"],
	...
	"#% increased Maximum Energy Shield for each Equipped Corrupted Item": ["explicit.stat_3916980068"],
	"#% increased Maximum Life for each Equipped Corrupted Item": ["explicit.stat_4169430079"],
	...
	"#% increased Maximum number of Summoned Raging Spirits": ["explicit.stat_1186934478"],
	...
	"#% increased Mine Damage": ["explicit.stat_2137912951", "crafted.stat_2137912951"],
	"#% increased Mine Laying Speed": ["explicit.stat_1896971621", "crafted.stat_1896971621"],
	...
	"#% increased Movement Speed": ["explicit.stat_2250533757", "implicit.stat_2250533757", "crafted.stat_2250533757"],
	...
	"#% increased Physical Damage (Local)": ["explicit.stat_1805374733", "implicit.stat_1805374733", "crafted.stat_1805374733"],
	...
	"#% increased Physical Damage taken over time": ["explicit.stat_511024200"],
	...
	"#% increased Projectile Speed": ["explicit.stat_3759663284", "implicit.stat_3759663284", "crafted.stat_3759663284"],
	...
	"#% increased Rarity of Items found": ["explicit.stat_3917489142", "implicit.stat_3917489142", "crafted.stat_3917489142"],
	...
	"#% increased Reflected Damage taken": ["explicit.stat_3846810663"],
	"#% increased Reflected Elemental Damage taken": ["explicit.stat_248838155"],
	"#% increased Reflected Elemental Damage taken while affected by Purity of Elements": ["explicit.stat_65331133"],
	"#% increased Reflected Physical Damage taken": ["explicit.stat_3158958938"],
	"#% increased Reflected Physical Damage taken while affected by Determination": ["explicit.stat_2457540491"],
	"#% increased Scorching Ray beam length": ["explicit.stat_702909553"],
	"#% increased Shock Duration on Enemies": ["explicit.stat_3668351662", "crafted.stat_3668351662"],
	...
	"#% increased Soul Cost of Vaal Skills": ["explicit.stat_678245679"],
	"#% increased Spark Duration": ["explicit.stat_3420284170"],
	"#% increased Spell Damage": ["explicit.stat_2974417149", "implicit.stat_2974417149", "crafted.stat_2974417149"],
	"#% increased Spell Damage during any Flask Effect": ["explicit.stat_2080171093"],
	"#% increased Spell Damage for each 200 total Mana you have Spent Recently": ["explicit.stat_347220474"],
	...
	"#% increased Spell Damage taken from Blinded Enemies": ["explicit.stat_1165847826"],
	...
	"#% increased Stun Duration on Enemies": ["explicit.stat_2517001139", "implicit.stat_2517001139", "crafted.stat_2517001139"],
	...
	"#% increased Trap Damage": ["explicit.stat_2941585404", "crafted.stat_2941585404"],
	"#% increased Trap Duration": ["explicit.stat_2001530951"],
	"#% increased Trap Throwing Speed": ["explicit.stat_118398748", "crafted.stat_118398748"],
	...
	"#% increased Vaal Skill Damage": ["explicit.stat_2257141320", "implicit.stat_2257141320"],
	"#% increased Vaal Skill Effect Duration": ["explicit.stat_547412107"],
	"#% increased Vulnerability Mana Reservation": ["explicit.stat_1798031916"],
	...
	"#% increased maximum Energy Shield": ["explicit.stat_2482852589", "implicit.stat_2482852589", "crafted.stat_2482852589"],
	...
	"#% increased number of Zombies allowed": ["explicit.stat_4041805509"],
	"#% less Critical Strike Chance": ["explicit.stat_4181057577"],
	"#% maximum Player Resistances": ["explicit.stat_3376488707"],
	"#% more Animate Weapon Duration": ["explicit.stat_414991155"],
	"#% more Damage taken if you have not been Hit Recently": ["explicit.stat_67637087"],
	...
	"#% more Mine Damage": ["explicit.stat_3298440988"],
	"#% more Minimum Physical Attack Damage": ["explicit.stat_1715495976"],
	"#% more Monster Life": ["explicit.stat_95249895"],
	"#% more Physical Damage with Unarmed Attacks": ["explicit.stat_2649720402"],
	"#% more Poison Duration": ["explicit.stat_1237693206"],
	"#% more Rare Monsters": ["explicit.stat_3793155082"],
	"#% more Rarity of Items Dropped by Imprisoned Monsters": ["explicit.stat_3130378100"],
	"#% more Weapon Damage": ["explicit.stat_4064867033"],
	"#% more effect of Curses on Monsters": ["explicit.stat_3796523155"],
	...
	"#% of Cold Damage Leeched as Life": ["explicit.stat_3999401129", "implicit.stat_3999401129", "crafted.stat_3999401129"],
	...
	"#% of Damage taken gained as Mana over 4 seconds when Hit": ["explicit.stat_472520716", "implicit.stat_472520716"],
	...
	"#% of Fire Damage Leeched as Life": ["explicit.stat_3848282610", "implicit.stat_3848282610", "crafted.stat_3848282610"],
	...
	"#% of Life Regenerated per second": ["explicit.stat_836936635", "implicit.stat_836936635"],
	...
	"#% of Lightning Damage Leeched as Life": ["explicit.stat_80079005", "implicit.stat_80079005", "crafted.stat_80079005"],
	...
	"#% of Physical Attack Damage Leeched as Life": ["explicit.stat_3593843976", "implicit.stat_3593843976", "crafted.stat_3593843976"],
	...
	"#% of Physical Attack Damage Leeched as Mana": ["explicit.stat_3237948413", "crafted.stat_3237948413"],
	...
	"#% reduced Enemy Stun Threshold with this Weapon": ["explicit.stat_832404842", "crafted.stat_832404842"],
	...
	"#% to Cold Resistance": ["explicit.stat_4220027924", "implicit.stat_4220027924", "crafted.stat_4220027924"],
	"#% to Cold Resistance when Socketed with a Green Gem": ["explicit.stat_1064331314"],
	"#% to Cold and Lightning Resistances": ["explicit.stat_4277795662", "implicit.stat_4277795662", "crafted.stat_4277795662"],
	...
	"#% to Fire Resistance": ["explicit.stat_3372524247", "implicit.stat_3372524247", "crafted.stat_3372524247"],
	...
	"#% to Fire and Cold Resistances": ["explicit.stat_2915988346", "implicit.stat_2915988346", "crafted.stat_2915988346"],
	"#% to Fire and Lightning Resistances": ["explicit.stat_3441501978", "implicit.stat_3441501978", "crafted.stat_3441501978"],
	"#% to Global Critical Strike Multiplier": ["explicit.stat_3556824919", "implicit.stat_3556824919", "crafted.stat_3556824919"],
	"#% to Lightning Resistance": ["explicit.stat_1671376347", "implicit.stat_1671376347", "crafted.stat_1671376347"],
	...
	"#% to all Elemental Resistances": ["explicit.stat_2901986750", "implicit.stat_2901986750", "crafted.stat_2901986750"],
	...
	"#% to all Resistances for each Equipped Corrupted Item": ["explicit.stat_3100523498"],
	...
	"1% increased Movement Speed per # Evasion Rating, up to 100%": ["explicit.stat_2591020064"],
	...
	"Adds # to # Chaos Damage to Attacks": ["explicit.stat_674553446", "implicit.stat_674553446", "crafted.stat_674553446"],
	...
	"Adds # to # Cold Damage (Local)": ["explicit.stat_1037193709", "implicit.stat_1037193709", "crafted.stat_1037193709"],
	...
	"Adds # to # Cold Damage to Attacks": ["explicit.stat_4067062424", "implicit.stat_4067062424", "crafted.stat_4067062424"],
	...
	"Adds # to # Cold Damage to Spells": ["explicit.stat_2469416729", "crafted.stat_2469416729"],
	...
	"Adds # to # Fire Damage (Local)": ["explicit.stat_709508406", "implicit.stat_709508406", "crafted.stat_709508406"],
	...
	"Adds # to # Fire Damage to Attacks": ["explicit.stat_1573130764", "implicit.stat_1573130764", "crafted.stat_1573130764"],
	...
	"Adds # to # Fire Damage to Spells": ["explicit.stat_1133016593", "crafted.stat_1133016593"],
	...
	"Adds # to # Lightning Damage (Local)": ["explicit.stat_3336890334", "implicit.stat_3336890334", "crafted.stat_3336890334"],
	...
	"Adds # to # Lightning Damage to Attacks": ["explicit.stat_1754445556", "implicit.stat_1754445556", "crafted.stat_1754445556"],
	...
	"Adds # to # Lightning Damage to Spells": ["explicit.stat_2831165374", "crafted.stat_2831165374"],
	...
	"Adds # to # Physical Damage (Local)": ["explicit.stat_1940865751", "implicit.stat_1940865751", "crafted.stat_1940865751"],
	...
	"Adds # to # Physical Damage to Attacks": ["explicit.stat_3032590688", "implicit.stat_3032590688", "crafted.stat_3032590688"],
	...
	"Area is inhabited by Solaris fanatics": ["explicit.stat_2457517302", "explicit.stat_1934713036"],
	...
	"Attack skills can have 1 additional Totem Summoned at a time": ["explicit.stat_3266394681"],
	...
	"Can have 1 additional Siege Ballista Totem per 200 Dexterity": ["explicit.stat_2125178364"],
	"Can have multiple Crafted Modifiers": ["crafted.stat_1859333175"],
	"Can have up to # additional Totem summoned at a time": ["explicit.stat_429867172"],
	...
	"Cannot gain Power Charges": ["explicit.stat_2503253050", "explicit.stat_1791497458"],
	...
	"Chance to Block Spell Damage is Lucky": ["explicit.stat_3551025193"],
	...
	"Chill Enemy for # second when Hit, slowing them by 30%": ["explicit.stat_2459809121"],
	...
	"Curses have #% increased effect on Monsters": ["explicit.stat_2999796964"],
	...
	"Damage from Enemies Hitting you is Lucky while you are Cursed with Vulnerability": ["explicit.stat_2758554648"],
	"Damage from Enemies Hitting you is Lucky while you are on Full Life": ["explicit.stat_3629143471"],
	"Damage from Enemies Hitting you is Lucky while you are on Low Life": ["explicit.stat_3753748365"],
	...
	"Debuffs on you expire #% slower while affected by Haste": ["explicit.stat_207635700"],
	...
	"During Flask Effect, #% increased Damage taken of each Element for which your Uncapped Elemental Resistance is lowest": ["explicit.stat_1869678332"],
	...
	"Enemies affected by your Spider's Webs deal #% increased Damage": ["explicit.stat_3231424461"],
	"Enemies affected by your Spider's Webs have #% to All Resistances": ["explicit.stat_785655723"],
	"Enemies have #% increased Evasion if you have Hit them Recently": ["explicit.stat_1773891268"],
	...
	"Enemies you Shock have #% increased Cast Speed": ["explicit.stat_4107150355"],
	"Enemies you Shock have #% increased Movement Speed": ["explicit.stat_3134790305"],
	...
	"Gain #% of Weapon Physical Damage as Extra Damage of an Element": ["explicit.stat_1038949719"],
	...
	"Golems Deal #% more Damage": ["explicit.stat_2861397339"],
	...
	"Golems have #% more Life": ["explicit.stat_3730242558"],
	...
	"Hits with this Weapon always inflict Elemental Ailments": ["explicit.stat_2451774989"],
	...
	"Imprisoned Monsters have #% increased Movement, Cast and Attack Speed": ["explicit.stat_712621072"],
	...
	"Left ring slot: #% increased Reflected Elemental Damage taken": ["explicit.stat_2422197812"],
	...
	"Minions deal #% increased Damage": ["explicit.stat_1589917703", "implicit.stat_1589917703", "crafted.stat_1589917703"],
	...
	"Minions have #% increased maximum Life": ["explicit.stat_770672621", "crafted.stat_770672621"],
	...
	"Monsters cannot be slowed below base speed": ["explicit.stat_798009319"],
	...
	"Nearby Enemies are Hindered, with #% increased Movement Speed": ["explicit.stat_607839150"],
	...
	"Nearby Enemies have #% increased Stun and Block Recovery": ["explicit.stat_3169825297"],
	...
	"Players gain #% increased Flask Charges": ["explicit.stat_2549889921"],
	...
	"Players have #% increased Chance to Block": ["explicit.stat_3729221884"],
	...
	"Players have #% more Area of Effect": ["explicit.stat_2312028586"],
	"Players have #% more Armour": ["explicit.stat_272758639"],
	"Players have #% more Recovery Rate of Life and Energy Shield": ["explicit.stat_4181072906"],
	...
	"Players take #% increased Damage from Breach Monsters": ["explicit.stat_1755438602"],
	"Players take #% increased Damage from Monsters from Beyond": ["explicit.stat_3045897926"],
	"Players with at least 50 Rampage Kills take #% increased Damage": ["explicit.stat_3045094957"],
	...
	"Poisons on you expire #% faster": ["explicit.stat_2443132097"],
	...
	"Projectiles Pierce an additional Target": ["explicit.stat_2067062068", "implicit.stat_2067062068"],
	...
	"Rare Monsters are Hindered, with #% increased Movement Speed": ["explicit.stat_3628993863"],
	...
	"Reflects # Physical Damage to Attackers on Block": ["explicit.stat_1445684883", "crafted.stat_1445684883"],
	"Reflects # Physical Damage to Melee Attackers": ["explicit.stat_3767873853", "implicit.stat_3767873853", "crafted.stat_3767873853"],
	...
	"Right ring slot: #% increased Reflected Physical Damage taken": ["explicit.stat_1357244124"],
	...
	"Skills Chain # times": ["explicit.stat_2426606435", "implicit.stat_2426606435"],
	...
	"Skills used during Flask effect grant #% of Mana Cost as Life over 4 Seconds": ["explicit.stat_3686711832"],
	...
	"Socketed Curse Gems have #% increased Mana Reservation": ["explicit.stat_1471600638"],
	...
	"Socketed Gems are Supported by Level # Blood Magic": ["explicit.stat_3922006600", "implicit.stat_3922006600", "crafted.stat_3922006600"],
	...
	"Socketed Gems are Supported by Level # Fire Penetration": ["explicit.stat_3265951306", "explicit.stat_1979658770"],
	...
	"Socketed Gems are Supported by Level # Reduced Mana": ["explicit.stat_749770518", "explicit.stat_1866911844", "implicit.stat_1866911844"],
	...
	"Socketed Gems have #% increased Elemental Equilibrium effect": ["explicit.stat_1408019802"],
	"Socketed Gems have #% increased Mana Reservation": ["explicit.stat_3289633055"],
	...
	"Socketed Spells have #% increased Mana Cost": ["explicit.stat_1688834903"],
	...
	"Summoned Holy Relics have #% increased Cooldown Recovery Speed": ["explicit.stat_1583498502"],
	...
	"Temporal Chains has #% increased Effect on you": ["explicit.stat_1152934561"],
	...
	"Vaal Skills have #% increased Soul Cost during effect": ["explicit.stat_1274125114"],
	"Vaal Skills used during effect do not apply Soul Gain Prevention": ["explicit.stat_2344590267"],
	"Vaal Skills used during effect have #% increased Soul Gain Prevention Duration": ["explicit.stat_902947445"],
	...
	"You can apply an additional Curse": ["explicit.stat_30642521", "implicit.stat_30642521"],
	...
	"You cannot be slowed to below base speed": ["explicit.stat_628716294"],
	...
	"You take #% increased Extra Damage from Critical Strikes while affected by Determination": ["explicit.stat_68410701"],
	"You take #% increased Extra Damage from Critical Strikes while you have no Power Charges": ["explicit.stat_3544527742"],
	...
	"Your Skills deal you #% of Mana Spent as Physical Damage": ["explicit.stat_99487834"],
