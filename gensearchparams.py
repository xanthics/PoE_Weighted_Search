...
def gensearchparams(dps, selections):
	modstr = {
		...
		"#% increased Attack Speed with Maces": dps['attackspeed'] if {'Mace'}.issubset(selections) else 0,
		...
		"#% increased Damage with One Handed Weapons": dps['pgeneric'] if {'Attack', 'Melee'}.issubset(selections) and {'TwoHandedWeapon'}.isdisjoint(selections) else 0,
		...
		"Adds # to # Cold Damage to Mace Attacks": dps['flatcold'] if {'Attack', 'Mace'}.issubset(selections) else 0,
		...
		"Adds # to # Fire Damage to Mace Attacks": dps['flatfire'] if {'Attack', 'Mace'}.issubset(selections) else 0,
		...
		"Adds # to # Lightning Damage to Mace Attacks": dps['flatlightning'] if {'Attack', 'Mace'}.issubset(selections) else 0,
		...
		"Adds # to # Physical Damage to Mace Attacks": dps['flatphys'] if {'Attack', 'Mace'}.issubset(selections) else 0,
