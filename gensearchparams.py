...
def gensearchparams(dps, selections):
	modstr = {
		...
		"#% increased Attack Speed if you've dealt a Critical Strike Recently": dps['attack speed'] if {'Recent Crit'}.issubset(selections) else 0,
		"#% increased Attack Speed while Dual Wielding": dps['attack speed'] if {'Dual Wielding'}.issubset(selections) else 0,
		...
		"#% increased Attack Speed with One Handed Melee Weapons": dps['attack speed'] if {'Melee'}.issubset(selections) and {'Two Handed Weapon'}.isdisjoint(selections) else 0,
		...
		"#% increased Attack Speed with Two Handed Melee Weapons": dps['attack speed'] if {'Two Handed Weapon'}.issubset(selections) else 0,
		...
		"#% increased Cast Speed if you've dealt a Critical Strike Recently": dps['cast speed'] if {'Recent Crit'}.issubset(selections) else 0,
		"#% increased Cast Speed while Dual Wielding": dps['cast speed'] if {'Dual Wielding'}.issubset(selections) else 0,
		...
		"#% increased Damage when on Full Life": dps['% generic'] if {'Full Life'}.issubset(selections) else 0,
