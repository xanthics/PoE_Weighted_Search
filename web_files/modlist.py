#!/usr/bin/python
# -*- coding: utf-8 -*-
# Generated: 06/20/2020(m/d/y) 00:20:09 utc
mods = {
	...
	"# to Melee Strike Range": ["crafted.stat_2264295449", "explicit.stat_2264295449"],
	...
	"Bathed in the blood of # sacrificed in the name of Xibaqua Passives in radius are Conquered by the Vaal": ["explicit.stat_3418580811"],
	...
	"Socketed Gems are Supported by Level # Archmage": ["explicit.stat_3652278215"],
	...
	"Socketed Gems are Supported by Level # Point Blank": ["explicit.stat_3754129682"],
	...
	"Socketed Gems are Supported by Level # Second Wind": ["explicit.stat_402499111"],
