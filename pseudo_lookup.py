#!/usr/bin/python
# -*- coding: utf-8 -*-
# Generated: 07/25/2020(m/d/y) 12:35:44 utc
...
def pseudo_lookup(modstr, base, reverse, selections):
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	if modstr["#% increased Cold Damage"] and (modstr["#% increased Cold Damage"] == modstr["#% increased Elemental Damage"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	if modstr["#% increased Fire Damage"] and (modstr["#% increased Fire Damage"] == modstr["#% increased Elemental Damage"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	if modstr["#% increased Lightning Damage"] and (modstr["#% increased Lightning Damage"] == modstr["#% increased Elemental Damage"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	if modstr["Adds # to # Chaos Damage"]:
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	if modstr["Adds # to # Lightning Damage"]:
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	if modstr["Adds # to # Physical Damage"]:
		# Assign the value to our pseudomod
