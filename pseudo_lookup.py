#!/usr/bin/python
# -*- coding: utf-8 -*-
# Generated: 07/25/2020(m/d/y) 14:03:19 utc
...
def pseudo_lookup(modstr, base, reverse, selections):
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["Adds # to # Chaos Damage to Spells"] and {"Spell"}.issubset(selections) and (modstr["Adds # to # Chaos Damage to Spells"] == modstr["Adds # to # Chaos Damage"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["Adds # to # Lightning Damage to Spells"] and {"Spell"}.issubset(selections) and (modstr["Adds # to # Lightning Damage to Spells"] == modstr["Adds # to # Lightning Damage"] == modstr["Adds # to # Lightning Damage to Spells and Attacks"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["Adds # to # Fire Damage to Spells"] and {"Spell"}.issubset(selections) and (modstr["Adds # to # Fire Damage to Spells"] == modstr["Adds # to # Fire Damage"] == modstr["Adds # to # Fire Damage to Spells and Attacks"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["Adds # to # Cold Damage to Spells"] and {"Spell"}.issubset(selections) and (modstr["Adds # to # Cold Damage to Spells"] == modstr["Adds # to # Cold Damage"] == modstr["Adds # to # Cold Damage to Spells and Attacks"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["Adds # to # Physical Damage to Spells"] and {"Spell"}.issubset(selections) and (modstr["Adds # to # Physical Damage to Spells"] == modstr["Adds # to # Physical Damage"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["Adds # to # Physical Damage"]:
		# Assign the value to our pseudomod
		ret["pseudo.pseudo_adds_physical_damage"] = round(modstr["Adds # to # Physical Damage"], 2)
		# zero out the mods being used by pseudomod.  Don't delete from list so that we don't crash if checked later
		modstr["Adds # to # Physical Damage"] = 0
		# Add mod to reverse lookup in case mod gets trimmed
		reverse["pseudo.pseudo_adds_physical_damage"] = "Adds # to # Physical Damage"
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["# to Intelligence"] and (modstr["# to Intelligence"] == modstr["# to Strength and Intelligence"] == modstr["# to Dexterity and Intelligence"] == modstr["# to all Attributes"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["# to Strength"] and (modstr["# to Strength"] == modstr["# to Strength and Intelligence"] == modstr["# to Strength and Dexterity"] == modstr["# to all Attributes"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["#% increased Cold Damage"] and {"Spell"}.issubset(selections) and (modstr["#% increased Cold Damage"] == modstr["#% increased Elemental Damage"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["#% increased Fire Damage"] and {"Attack"}.issubset(selections) and (modstr["#% increased Fire Damage"] == modstr["#% increased Elemental Damage"] == modstr["#% increased Elemental Damage with Attack Skills"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["#% increased Fire Damage"] and {"Spell"}.issubset(selections) and (modstr["#% increased Fire Damage"] == modstr["#% increased Elemental Damage"]):
		# Assign the value to our pseudomod
	...
	# Check that the value is non-zero and if necessary that it isn't a bad base for that mod and that all values are equal
	elif modstr["#% increased Lightning Damage"] and {"Spell"}.issubset(selections) and (modstr["#% increased Lightning Damage"] == modstr["#% increased Elemental Damage"]):
		# Assign the value to our pseudomod
